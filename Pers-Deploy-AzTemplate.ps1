...
$ArtifactStagingDirectory = 'C:\Users\elanzelm\source\repos\Arm Templates\azure-quickstart-templates\101-vm-simple-windows'
$Location = "WestEurope"
$ResourceGroupName = "ArmTest"
$StorageAccountName = "SA_Arms"
$StorageContainerName = $ResourceGroupName.ToLowerInvariant() + '-stageartifacts'
$TemplateFile = $ArtifactStagingDirectory + '\mainTemplate.json'
$TemplateParametersFile = $ArtifactStagingDirectory + '.\azuredeploy.parameters.json'
$DSCSourceFolder = $ArtifactStagingDirectory + '.\DSC'
$DebugOptions = "All"
#$Mode = "Incremental"
$Mode="Complete"
$DeploymentName = ((Split-Path $TemplateFile -LeafBase) + '-' + ((Get-Date).ToUniversalTime()).ToString('MMdd-HHmm'))
$Dev=$true
$ValidateOnly=$false
$UploadArtifacts=$false
$BuildDscPackage=$false
